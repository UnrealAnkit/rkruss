...
export const mauritiusUniversities: CountryUniversities = {
  ...
  universities: [
    ...
    {
      name: "Université des Mascareignes (UDM)",
      ...
      admission: "Moderate",
      tuition: "≈$3,200 (International)",
      accommodation: "≈$1,900 per year",
      duration: "3-4 years",
      type: "Government",
      image: "/udm.jpg",
      features: [
