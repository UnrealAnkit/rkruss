...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full h-[240px] xs:h-[280px] sm:h-[320px] md:h-[360px] lg:h-screen xl:h-screen overflow-hidden bg-slate-900 mt-20 md:mt-0 lg:mt-0">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-red-600 text-white py-1 xs:py-1.5 sm:py-2 z-10">
        <div className="container mx-auto px-2 xs:px-3 sm:px-4">
          <div className="flex items-center w-full">
            <span className="bg-yellow-500 text-black px-1.5 xs:px-2 sm:px-2.5 py-0.5 rounded-full text-xs font-bold flex-shrink-0">
              Latest News
            </span>
