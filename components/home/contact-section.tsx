            ...
            <Card className="shadow-xl">
              <CardHeader>
                ...
                <p className="text-slate-600">
                  Fill out this form to receive a personalized consultation about your study abroad opportunities.
                </p>
              </CardHeader>
              <CardContent>
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-600">
                      Your assessment has been submitted successfully. Our team will contact you within 24 hours.
                    </p>
                  </motion.div>
                ) : (
                  <Form {...form}>
